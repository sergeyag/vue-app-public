            ...
            >
                <template v-slot:top>
                    <v-toolbar flat color="white">
                        <v-toolbar-title>Список кинотеатров</v-toolbar-title>
                        <v-divider
                                class="mx-4"
                                inset
                                vertical
                        ...
                        <v-dialog v-model="dialog" max-width="500px">
                            <template v-slot:activator="{ on }">
                                <v-btn color="primary" dark class="mb-2" v-on="on">Создать запись вручную</v-btn>
                            </template>
                            <v-card>
                                <v-card-title>
    ...
    export default {
        data () {
            return {
                ...
                headers: [
                    { text: 'id', value: 'id' },
                    { text: 'Адрес', value: 'text' },
                    { text: 'Название', value: 'subject' },
